(defproject kitchen "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "kitchen.core/on-js-reload"
                ...
                :compiler {:main kitchen.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/kitchen.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/kitchen.js"
                           :main kitchen.core
